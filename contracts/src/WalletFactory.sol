...
contract WalletFactory {
    ...
    /*
     * @dev returns the counterfactual address for a to-be-deployed contract
     */
    function getAddress(
        address[] memory owners,
        uint256 salt
    ) public view returns (address) {
        //Enocde the initialize function in our wallet with the owners array as an argument into a bytes array
    ...
    function createAccount(
        ...
        if (codeSize > 0) {
            //If code is non-empty i.e account already deployed, return the Wallet at the counterfactual address
